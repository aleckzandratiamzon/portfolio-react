                ...
                <div className="text-center text-xxl-start">
                  ...
                  <h1 className="display-3 fw-bolder mb-5">
                    <span className="text-gradient d-inline">
                      Transform Your Ideas Into Cutting-Edge Software Solutions
                    </span>
                  </h1>
              ...
              <div className="col-xxl-8">
                <div className="text-center my-5">
                  ...
                  <p className="lead fw-light mb-4">
                    I'm Aleckzandra I specialize in crafting innovative,
                    scalable, and high-performance software solutions tailored
                    to your needs.
                  </p>
                  <p className="text-muted">
                    With a deep understanding of the latest technologies and
                    industry trends, I work closely with clients to turn their
                    ideas into functional, efficient, and user-friendly
                    software. Whether you're looking to develop a web app,
                    mobile app, or enterprise solution, I bring expertise,
                    creativity, and dedication to every project, ensuring it
                    meets your unique requirements and goals.
                  </p>
                </div>
              </div>
            </div>
